...
Route::post('registerpost', 'Auth\RegisterController@registerUser')->name('registerpost');
});

Route::get('login', function () { return view('custom_auth.login'); })->name('login');
...
Route::get('researchers/edit/', 'ResearcherController@edit')->name('researchers.editor');
Route::get('researchers/delete/', 'ResearcherController@destroy')->name('researchers.deleter');
Route::post('researchers/update/{researcher}', 'ResearcherController@update')->name('researchers.updator');
